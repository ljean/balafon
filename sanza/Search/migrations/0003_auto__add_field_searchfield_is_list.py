...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchField.is_list'
        db.add_column(u'Search_searchfield', 'is_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchField.is_list'
        db.delete_column(u'Search_searchfield', 'is_list')
