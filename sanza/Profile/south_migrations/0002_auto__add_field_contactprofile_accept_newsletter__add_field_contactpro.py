...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactProfile.accept_newsletter'
        db.add_column('Profile_contactprofile', 'accept_newsletter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ContactProfile.accept_3rdparty'
        db.add_column('Profile_contactprofile', 'accept_3rdparty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ContactProfile.contact'
        db.alter_column('Profile_contactprofile', 'contact_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['Crm.Contact'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'ContactProfile.accept_newsletter'
        db.delete_column('Profile_contactprofile', 'accept_newsletter')

        # Deleting field 'ContactProfile.accept_3rdparty'
        db.delete_column('Profile_contactprofile', 'accept_3rdparty')


        # User chose to not deal with backwards NULL issues for 'ContactProfile.contact'
        raise RuntimeError("Cannot reverse this migration. 'ContactProfile.contact' and its values cannot be restored.")
