...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactProfile.entity_name'
        db.add_column(u'Profile_contactprofile', 'entity_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.entity_type'
        db.add_column(u'Profile_contactprofile', 'entity_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.EntityType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.zip_code'
        db.add_column(u'Profile_contactprofile', 'zip_code',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.city'
        db.add_column(u'Profile_contactprofile', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.City'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactProfile.entity_name'
        db.delete_column(u'Profile_contactprofile', 'entity_name')

        # Deleting field 'ContactProfile.entity_type'
        db.delete_column(u'Profile_contactprofile', 'entity_type_id')

        # Deleting field 'ContactProfile.zip_code'
        db.delete_column(u'Profile_contactprofile', 'zip_code')

        # Deleting field 'ContactProfile.city'
        db.delete_column(u'Profile_contactprofile', 'city_id')
