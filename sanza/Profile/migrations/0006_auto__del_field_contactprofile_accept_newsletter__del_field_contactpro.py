...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'Profile_contactprofile', 'accept_newsletter')

        # Deleting field 'ContactProfile.accept_3rdparty'
        db.delete_column(u'Profile_contactprofile', 'accept_3rdparty')

        # Adding field 'ContactProfile.subscriptions_ids'
        db.add_column(u'Profile_contactprofile', 'subscriptions_ids',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'Profile_contactprofile', 'accept_newsletter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ContactProfile.accept_3rdparty'
        db.add_column(u'Profile_contactprofile', 'accept_3rdparty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ContactProfile.subscriptions_ids'
        db.delete_column(u'Profile_contactprofile', 'subscriptions_ids')
    ...
    models = {
        ...
        u'Profile.contactprofile': {
            ...
            'gender': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subscriptions_ids': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
