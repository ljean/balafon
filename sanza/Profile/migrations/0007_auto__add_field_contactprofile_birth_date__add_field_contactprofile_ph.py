...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactProfile.birth_date'
        db.add_column(u'Profile_contactprofile', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.phone'
        db.add_column(u'Profile_contactprofile', 'phone',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.mobile'
        db.add_column(u'Profile_contactprofile', 'mobile',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.address'
        db.add_column(u'Profile_contactprofile', 'address',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.address2'
        db.add_column(u'Profile_contactprofile', 'address2',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.address3'
        db.add_column(u'Profile_contactprofile', 'address3',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.cedex'
        db.add_column(u'Profile_contactprofile', 'cedex',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactProfile.birth_date'
        db.delete_column(u'Profile_contactprofile', 'birth_date')

        # Deleting field 'ContactProfile.phone'
        db.delete_column(u'Profile_contactprofile', 'phone')

        # Deleting field 'ContactProfile.mobile'
        db.delete_column(u'Profile_contactprofile', 'mobile')

        # Deleting field 'ContactProfile.address'
        db.delete_column(u'Profile_contactprofile', 'address')

        # Deleting field 'ContactProfile.address2'
        db.delete_column(u'Profile_contactprofile', 'address2')

        # Deleting field 'ContactProfile.address3'
        db.delete_column(u'Profile_contactprofile', 'address3')

        # Deleting field 'ContactProfile.cedex'
        db.delete_column(u'Profile_contactprofile', 'cedex')
