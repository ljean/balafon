...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactProfile.groups_ids'
        db.add_column(u'Profile_contactprofile', 'groups_ids',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactProfile.groups_ids'
        db.delete_column(u'Profile_contactprofile', 'groups_ids')
    ...
    models = {
        ...
        u'Profile.contactprofile': {
            ...
            'firstname': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '200', 'blank': 'True'}),
            'gender': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'groups_ids': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
