...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Crm_teammember', (
        ...
        db.send_create_signal(u'Crm', ['TeamMember'])

        # Adding field 'Action.in_charge'
        db.add_column(u'Crm_action', 'in_charge',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.TeamMember'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TeamMember'
        db.delete_table(u'Crm_teammember')

        # Deleting field 'Action.in_charge'
        db.delete_column(u'Crm_action', 'in_charge_id')
    ...
    models = {
        u'Crm.action': {
            ...
            'in_charge_backup': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'backup_action_set'", 'null': 'True', 'blank': 'True', 'to': u"orm['auth.User']"}),
