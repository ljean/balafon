...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActionType.mail_to_subject'
        db.add_column(u'Crm_actiontype', 'mail_to_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

    def backwards(self, orm):

        # Deleting field 'ActionType.mail_to_subject'
        db.delete_column(u'Crm_actiontype', 'mail_to_subject')
    ...
    models = {
        ...
        u'Crm.actiontype': {
            ...
            'mail_to_subject': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        u'Crm.customfield': {
            'Meta': {'ordering': "('ordering', 'import_order', 'export_order')", 'object_name': 'CustomField'},
