...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.not_assigned_when_cloned'
        db.add_column(u'Crm_actiontype', 'not_assigned_when_cloned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.not_assigned_when_cloned'
        db.delete_column(u'Crm_actiontype', 'not_assigned_when_cloned')
