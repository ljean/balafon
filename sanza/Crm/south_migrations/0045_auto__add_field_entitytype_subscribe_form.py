...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityType.subscribe_form'
        db.add_column('Crm_entitytype', 'subscribe_form',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityType.subscribe_form'
        db.delete_column('Crm_entitytype', 'subscribe_form')
