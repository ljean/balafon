...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.in_charge_backup'
        db.add_column(u'Crm_action', 'in_charge_backup',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='backup_action_set', null=True, blank=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.in_charge_backup'
        db.delete_column(u'Crm_action', 'in_charge_backup_id')
