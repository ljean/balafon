...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        staff = {}
        for staff_user in orm['auth.User'].objects.filter(is_staff=True).exclude(last_name=''):
            staff[staff_user.username] = orm.TeamMember.objects.create(
                user=staff_user,
                name=u'{0} {1}'.format(staff_user.first_name, staff_user.last_name)
            )
