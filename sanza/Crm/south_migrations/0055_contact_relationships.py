...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Crm_relationship', (
            ...
            ('contact1', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'relationships1', to=orm['Crm.Contact'])),
            ('contact2', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'relationships2', to=orm['Crm.Contact'])),
            ('relationship_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.RelationshipType'])),
        ))
        db.send_create_signal(u'Crm', ['Relationship'])

        # Adding model 'RelationshipType'
        db.create_table(u'Crm_relationshiptype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('reverse', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
        ))
        db.send_create_signal(u'Crm', ['RelationshipType'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'Crm_relationshiptype')
