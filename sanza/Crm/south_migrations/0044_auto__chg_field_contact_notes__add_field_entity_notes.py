...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Crm_contact', 'notes', self.gf('django.db.models.fields.TextField')())
        # Adding field 'Entity.notes'
        db.add_column('Crm_entity', 'notes',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Contact.notes'
        db.alter_column('Crm_contact', 'notes', self.gf('django.db.models.fields.CharField')(max_length=500))
        # Deleting field 'Entity.notes'
        db.delete_column('Crm_entity', 'notes')
