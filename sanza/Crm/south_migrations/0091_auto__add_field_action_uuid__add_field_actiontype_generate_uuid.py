...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.uuid'
        db.add_column(u'Crm_action', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionType.generate_uuid'
        db.add_column(u'Crm_actiontype', 'generate_uuid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.uuid'
        db.delete_column(u'Crm_action', 'uuid')

        # Deleting field 'ActionType.generate_uuid'
        db.delete_column(u'Crm_actiontype', 'generate_uuid')
