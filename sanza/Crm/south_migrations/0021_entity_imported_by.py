...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entity.imported_by'
        db.add_column('Crm_entity', 'imported_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.ContactsImport'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entity.imported_by'
        db.delete_column('Crm_entity', 'imported_by_id')
