...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.accept_newsletter'
        db.delete_column(u'Crm_contact', 'accept_newsletter')

        # Deleting field 'Contact.accept_3rdparty'
        db.delete_column(u'Crm_contact', 'accept_3rdparty')


    def backwards(self, orm):
        # Adding field 'Contact.accept_newsletter'
        db.add_column(u'Crm_contact', 'accept_newsletter',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Contact.accept_3rdparty'
        db.add_column(u'Crm_contact', 'accept_3rdparty',
