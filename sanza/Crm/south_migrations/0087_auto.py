...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field only_for_status on 'ActionMenu'
        m2m_table_name = db.shorten_name(u'Crm_actionmenu_only_for_status')
        ...
        db.create_unique(m2m_table_name, ['actionmenu_id', 'actionstatus_id'])


    def backwards(self, orm):
        # Removing M2M table for field only_for_status on 'ActionMenu'
        db.delete_table(db.shorten_name(u'Crm_actionmenu_only_for_status'))
