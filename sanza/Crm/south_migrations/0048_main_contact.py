...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SameAs.main_contact'
        db.add_column(u'Crm_sameas', 'main_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.Contact'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SameAs.main_contact'
        db.delete_column(u'Crm_sameas', 'main_contact_id')
