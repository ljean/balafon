...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opportunity.entity'
        db.alter_column('Crm_opportunity', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.Entity'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Opportunity.entity'
        raise RuntimeError("Cannot reverse this migration. 'Opportunity.entity' and its values cannot be restored.")
