...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamMember.user'
        db.alter_column(u'Crm_teammember', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'TeamMember', fields ['user']
        db.create_unique(u'Crm_teammember', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TeamMember', fields ['user']
        db.delete_unique(u'Crm_teammember', ['user_id'])


        # Changing field 'TeamMember.user'
        db.alter_column(u'Crm_teammember', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
