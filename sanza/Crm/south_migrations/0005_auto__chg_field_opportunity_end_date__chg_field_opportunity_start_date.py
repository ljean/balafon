...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opportunity.end_date'
        db.alter_column('Crm_opportunity', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Opportunity.start_date'
        db.alter_column('Crm_opportunity', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Opportunity.end_date'
        db.alter_column('Crm_opportunity', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Opportunity.start_date'
        db.alter_column('Crm_opportunity', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
