...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.address2'
        db.add_column('Crm_contact', 'address2', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True), keep_default=False)

        # Adding field 'Contact.address3'
        db.add_column('Crm_contact', 'address3', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True), keep_default=False)

        # Adding field 'Group.subscribe_form'
        db.add_column('Crm_group', 'subscribe_form', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Entity.address2'
        db.add_column('Crm_entity', 'address2', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True), keep_default=False)

        # Adding field 'Entity.address3'
        db.add_column('Crm_entity', 'address3', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.address2'
        db.delete_column('Crm_contact', 'address2')

        # Deleting field 'Contact.address3'
        db.delete_column('Crm_contact', 'address3')

        # Deleting field 'Group.subscribe_form'
        db.delete_column('Crm_group', 'subscribe_form')

        # Deleting field 'Entity.address2'
        db.delete_column('Crm_entity', 'address2')

        # Deleting field 'Entity.address3'
        db.delete_column('Crm_entity', 'address3')
