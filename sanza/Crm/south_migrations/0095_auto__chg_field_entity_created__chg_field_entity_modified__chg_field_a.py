...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entity.created'
        db.alter_column(u'Crm_entity', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Entity.modified'
        db.alter_column(u'Crm_entity', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Action.created'
        db.alter_column(u'Crm_action', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Action.modified'
        db.alter_column(u'Crm_action', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Contact.modified'
        db.alter_column(u'Crm_contact', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Contact.created'
        db.alter_column(u'Crm_contact', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Relationship.created'
        db.alter_column(u'Crm_relationship', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Relationship.modified'
        db.alter_column(u'Crm_relationship', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Group.created'
        db.alter_column(u'Crm_group', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Group.modified'
        db.alter_column(u'Crm_group', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ContactsImport.modified'
        db.alter_column(u'Crm_contactsimport', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ContactsImport.created'
        db.alter_column(u'Crm_contactsimport', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Opportunity.created'
        db.alter_column(u'Crm_opportunity', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Opportunity.modified'
        db.alter_column(u'Crm_opportunity', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Entity.created'
        db.alter_column(u'Crm_entity', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Entity.modified'
        db.alter_column(u'Crm_entity', 'modified', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Action.created'
        db.alter_column(u'Crm_action', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Action.modified'
        db.alter_column(u'Crm_action', 'modified', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Contact.modified'
        db.alter_column(u'Crm_contact', 'modified', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Contact.created'
        db.alter_column(u'Crm_contact', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Relationship.created'
        db.alter_column(u'Crm_relationship', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Relationship.modified'
        db.alter_column(u'Crm_relationship', 'modified', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Group.created'
        db.alter_column(u'Crm_group', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Group.modified'
        db.alter_column(u'Crm_group', 'modified', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ContactsImport.modified'
        db.alter_column(u'Crm_contactsimport', 'modified', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ContactsImport.created'
        db.alter_column(u'Crm_contactsimport', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Opportunity.created'
        db.alter_column(u'Crm_opportunity', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Opportunity.modified'
        db.alter_column(u'Crm_opportunity', 'modified', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'Crm.actiontype': {
            ...
            'hide_contacts_buttons': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'Crm.opportunity': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'detail': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'display_on_board': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
