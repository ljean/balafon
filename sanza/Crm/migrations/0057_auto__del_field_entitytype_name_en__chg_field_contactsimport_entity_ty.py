...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'ContactsImport.entity_type'
        db.alter_column(u'Crm_contactsimport', 'entity_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.EntityType'], null=True))

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'ContactsImport.entity_type'
        raise RuntimeError("Cannot reverse this migration. 'ContactsImport.entity_type' and its values cannot be restored.")
