...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionStatus.is_final'
        db.add_column(u'Crm_actionstatus', 'is_final',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActionStatus.fore_color'
        db.add_column(u'Crm_actionstatus', 'fore_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)

        # Adding field 'ActionStatus.background_color'
        db.add_column(u'Crm_actionstatus', 'background_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)

        # Adding field 'ActionType.hide_contacts_buttons'
        db.add_column(u'Crm_actiontype', 'hide_contacts_buttons',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionStatus.is_final'
        db.delete_column(u'Crm_actionstatus', 'is_final')

        # Deleting field 'ActionStatus.fore_color'
        db.delete_column(u'Crm_actionstatus', 'fore_color')

        # Deleting field 'ActionStatus.background_color'
        db.delete_column(u'Crm_actionstatus', 'background_color')

        # Deleting field 'ActionType.hide_contacts_buttons'
        db.delete_column(u'Crm_actiontype', 'hide_contacts_buttons')
