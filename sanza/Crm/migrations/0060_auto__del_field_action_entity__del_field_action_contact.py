...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Action.entity'
        db.delete_column(u'Crm_action', 'entity_id')

        # Deleting field 'Action.contact'
        db.delete_column(u'Crm_action', 'contact_id')


    def backwards(self, orm):
        # Adding field 'Action.entity'
        db.add_column(u'Crm_action', 'entity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.Entity'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Action.contact'
        db.add_column(u'Crm_action', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.Contact'], null=True, blank=True),
                      keep_default=False)
