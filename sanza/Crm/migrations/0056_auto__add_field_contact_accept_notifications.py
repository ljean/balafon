...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.accept_notifications'
        db.add_column(u'Crm_contact', 'accept_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.accept_notifications'
        db.delete_column(u'Crm_contact', 'accept_notifications')
