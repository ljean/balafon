...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CustomField.simple_form'
        db.delete_column('Crm_customfield', 'simple_form')

        # Adding field 'CustomField.ordering'
        db.add_column('Crm_customfield', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CustomField.simple_form'
        db.add_column('Crm_customfield', 'simple_form', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'CustomField.ordering'
        db.delete_column('Crm_customfield', 'ordering')
