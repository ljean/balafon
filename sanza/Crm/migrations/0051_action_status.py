...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Crm_actionstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ))
        db.send_create_signal(u'Crm', ['ActionStatus'])

        # Adding field 'Action.status'
        db.add_column(u'Crm_action', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.ActionStatus'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field allowed_status on 'ActionType'
        m2m_table_name = db.shorten_name(u'Crm_actiontype_allowed_status')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('actiontype', models.ForeignKey(orm[u'Crm.actiontype'], null=False)),
            ('actionstatus', models.ForeignKey(orm[u'Crm.actionstatus'], null=False))
        ))
        db.create_unique(m2m_table_name, ['actiontype_id', 'actionstatus_id'])


    def backwards(self, orm):
        # Deleting model 'ActionStatus'
        db.delete_table(u'Crm_actionstatus')

        # Deleting field 'Action.status'
        db.delete_column(u'Crm_action', 'status_id')

        # Removing M2M table for field allowed_status on 'ActionType'
        db.delete_table(db.shorten_name(u'Crm_actiontype_allowed_status'))
