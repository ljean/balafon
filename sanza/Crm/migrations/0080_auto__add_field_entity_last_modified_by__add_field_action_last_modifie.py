...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.last_modified_by'
        db.add_column(u'Crm_entity', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Action.last_modified_by'
        db.add_column(u'Crm_action', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contact.last_modified_by'
        db.add_column(u'Crm_contact', 'last_modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.last_modified_by'
        db.delete_column(u'Crm_entity', 'last_modified_by_id')

        # Deleting field 'Action.last_modified_by'
        db.delete_column(u'Crm_action', 'last_modified_by_id')

        # Deleting field 'Contact.last_modified_by'
        db.delete_column(u'Crm_contact', 'last_modified_by_id')
