...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.default_status'
        db.add_column(u'Crm_actiontype', 'default_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='type_default_status_set', null=True, blank=True, to=orm['Crm.ActionStatus']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.default_status'
        db.delete_column(u'Crm_actiontype', 'default_status_id')
