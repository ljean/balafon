...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sites on 'SubscriptionType'
        m2m_table_name = db.shorten_name(u'Crm_subscriptiontype_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subscriptiontype', models.ForeignKey(orm[u'Crm.subscriptiontype'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['subscriptiontype_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sites on 'SubscriptionType'
        db.delete_table(db.shorten_name(u'Crm_subscriptiontype_sites'))
