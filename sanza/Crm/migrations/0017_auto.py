...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field groups on 'City'
        db.create_table('Crm_city_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('city', models.ForeignKey(orm['Crm.city'], null=False)),
            ('zone', models.ForeignKey(orm['Crm.zone'], null=False))
        ))
        db.create_unique('Crm_city_groups', ['city_id', 'zone_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field groups on 'City'
        db.delete_table('Crm_city_groups')
