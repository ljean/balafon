...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.is_amount_calculated'
        db.add_column(u'Crm_actiontype', 'is_amount_calculated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.is_amount_calculated'
        db.delete_column(u'Crm_actiontype', 'is_amount_calculated')
