...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.fore_color'
        db.add_column(u'Crm_group', 'fore_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)

        # Adding field 'Group.background_color'
        db.add_column(u'Crm_group', 'background_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.fore_color'
        db.delete_column(u'Crm_group', 'fore_color')

        # Deleting field 'Group.background_color'
        db.delete_column(u'Crm_group', 'background_color')
