...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opportunity.status'
        db.alter_column(u'Crm_opportunity', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.OpportunityStatus'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Opportunity.status'
        raise RuntimeError("Cannot reverse this migration. 'Opportunity.status' and its values cannot be restored.")
