...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.end_datetime'
        db.add_column(u'Crm_action', 'end_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.end_datetime'
        db.delete_column(u'Crm_action', 'end_datetime')
