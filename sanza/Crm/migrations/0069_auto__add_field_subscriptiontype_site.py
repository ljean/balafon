...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubscriptionType.site'
        db.add_column(u'Crm_subscriptiontype', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubscriptionType.site'
        db.delete_column(u'Crm_subscriptiontype', 'site_id')
    ...
    models = {
        ...
        u'Crm.subscriptiontype': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'to_be_deleted'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['sites.Site']"})
        },
        u'Crm.zone': {
