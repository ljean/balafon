...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.number'
        db.add_column(u'Crm_action', 'number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ActionType.last_number'
        db.add_column(u'Crm_actiontype', 'last_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ActionType.number_auto_generated'
        db.add_column(u'Crm_actiontype', 'number_auto_generated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.number'
        db.delete_column(u'Crm_action', 'number')

        # Deleting field 'ActionType.last_number'
        db.delete_column(u'Crm_actiontype', 'last_number')

        # Deleting field 'ActionType.number_auto_generated'
        db.delete_column(u'Crm_actiontype', 'number_auto_generated')
    ...
    models = {
        u'Crm.action': {
            ...
            'subject': ('django.db.models.fields.CharField', [], {'default': 'True', 'max_length': '200', 'blank': 'True'}),
