...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Crm_streettype', (
        ...
        # Adding field 'Entity.street_type'
        db.add_column(u'Crm_entity', 'street_type',
        ...
        # Adding field 'Contact.street_type'
        db.add_column(u'Crm_contact', 'street_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.StreetType'], null=True, blank=True),
                      keep_default=False)
