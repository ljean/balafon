...
urlpatterns = patterns('sanza.Crm.views',
    ...
    url(r'^view-contact-actions/(?P<contact_id>\d+)/(?P<action_set_id>\d+)/$', 'view_all_contact_actions', name='crm_view_contact_actions'),
    url(r'^view-entity-actions/(?P<entity_id>\d+)/(?P<action_set_id>\d+)/$', 'view_all_entity_actions', name='crm_view_entity_actions'),
    url(r'^same-as/(?P<contact_id>\d+)/$', 'same_as', name='crm_same_as'),
    url(r'^remove-same-as/(?P<current_contact_id>\d+)/(?P<contact_id>\d+)/$', 'remove_same_as', name='crm_remove_same_as'),
    ...
    url(r'^make-main-contact/(?P<current_contact_id>\d+)/(?P<contact_id>\d+)/$', 'make_main_contact', name='crm_make_main_contact'),
