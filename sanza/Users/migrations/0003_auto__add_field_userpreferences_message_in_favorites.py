...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPreferences.message_in_favorites'
        db.add_column(u'Users_userpreferences', 'message_in_favorites',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPreferences.message_in_favorites'
        db.delete_column(u'Users_userpreferences', 'message_in_favorites')
