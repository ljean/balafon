...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomMenuItem.attributes'
        db.add_column(u'Users_custommenuitem', 'attributes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomMenuItem.attributes'
        db.delete_column(u'Users_custommenuitem', 'attributes')
