...
SEARCH_FORM_LIST = 'sanza.config.SEARCH_FORMS'
SANZA_DEFAULT_COUNTRY = 'France'
SANZA_MY_COMPANY = "Apidev"
SANZA_AS_HOMEPAGE = False
SANZA_NOTIFICATION_EMAIL = 'ljean@apidev.fr'
SANZA_UNACCENT_FILTER_SUPPORT = True
