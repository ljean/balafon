...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoreManagementActionType'
        db.create_table(u'Store_storemanagementactiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action_type', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['Crm.ActionType'], unique=True)),
        ))
        db.send_create_signal(u'Store', ['StoreManagementActionType'])


    def backwards(self, orm):
        # Deleting model 'StoreManagementActionType'
        db.delete_table(u'Store_storemanagementactiontype')
