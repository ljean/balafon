...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeliveryPoint'
        db.create_table(u'Store_deliverypoint', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'Store', ['DeliveryPoint'])

        # Adding field 'Sale.delivery_point'
        db.add_column(u'Store_sale', 'delivery_point',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.DeliveryPoint'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DeliveryPoint'
        db.delete_table(u'Store_deliverypoint')

        # Deleting field 'Sale.delivery_point'
        db.delete_column(u'Store_sale', 'delivery_point_id')
