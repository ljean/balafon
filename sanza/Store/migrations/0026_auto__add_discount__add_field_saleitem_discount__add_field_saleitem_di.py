...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Store_discount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'Store', ['Discount'])

        # Adding M2M table for field tags on 'Discount'
        m2m_table_name = db.shorten_name(u'Store_discount_tags')
        ...
        db.create_unique(m2m_table_name, ['discount_id', 'storeitemtag_id'])

        # Adding field 'SaleItem.discount'
        db.add_column(u'Store_saleitem', 'discount',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.Discount'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SaleItem.discount_price'
        db.add_column(u'Store_saleitem', 'discount_price',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'Store_discount')

        # Removing M2M table for field tags on 'Discount'
        db.delete_table(db.shorten_name(u'Store_discount_tags'))

        # Deleting field 'SaleItem.discount'
        db.delete_column(u'Store_saleitem', 'discount_id')

        # Deleting field 'SaleItem.discount_price'
        db.delete_column(u'Store_saleitem', 'discount_price')
