...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Store_certificate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True)),
        ))
        db.send_create_signal(u'Store', ['Certificate'])

        # Adding M2M table for field certificates on 'StoreItem'
        m2m_table_name = db.shorten_name(u'Store_storeitem_certificates')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('storeitem', models.ForeignKey(orm[u'Store.storeitem'], null=False)),
            ('certificate', models.ForeignKey(orm[u'Store.certificate'], null=False))
        ))
        db.create_unique(m2m_table_name, ['storeitem_id', 'certificate_id'])


    def backwards(self, orm):
        # Deleting model 'Certificate'
        db.delete_table(u'Store_certificate')

        # Removing M2M table for field certificates on 'StoreItem'
        db.delete_table(db.shorten_name(u'Store_storeitem_certificates'))
    ...
    models = {
        ...
        u'Store.discount': {
            'Meta': {'ordering': "['rate', 'name']", 'object_name': 'Discount'},
        ...
        u'Store.storeitem': {
            ...
            'certificates': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Store.Certificate']", 'symmetrical': 'False', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
