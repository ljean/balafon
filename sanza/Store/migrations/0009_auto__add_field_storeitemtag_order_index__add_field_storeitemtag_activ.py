...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemTag.order_index'
        db.add_column(u'Store_storeitemtag', 'order_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'StoreItemTag.active'
        db.add_column(u'Store_storeitemtag', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'StoreItemCategory.order_index'
        db.add_column(u'Store_storeitemcategory', 'order_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'StoreItemCategory.active'
        db.add_column(u'Store_storeitemcategory', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemTag.order_index'
        db.delete_column(u'Store_storeitemtag', 'order_index')

        # Deleting field 'StoreItemTag.active'
        db.delete_column(u'Store_storeitemtag', 'active')

        # Deleting field 'StoreItemCategory.order_index'
        db.delete_column(u'Store_storeitemcategory', 'order_index')

        # Deleting field 'StoreItemCategory.active'
        db.delete_column(u'Store_storeitemcategory', 'active')
