...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemImport.category_lines_mode'
        db.add_column(u'Store_storeitemimport', 'category_lines_mode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemImport.category_lines_mode'
        db.delete_column(u'Store_storeitemimport', 'category_lines_mode')
