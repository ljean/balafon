...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SaleItem.is_blank'
        db.add_column(u'Store_saleitem', 'is_blank',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'SaleItem.vat_rate'
        db.alter_column(u'Store_saleitem', 'vat_rate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Store.VatRate'], null=True))

    def backwards(self, orm):
        # Deleting field 'SaleItem.is_blank'
        db.delete_column(u'Store_saleitem', 'is_blank')


        # Changing field 'SaleItem.vat_rate'
        db.alter_column(u'Store_saleitem', 'vat_rate_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Store.VatRate']))
