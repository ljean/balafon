...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Store_saleitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Store.Sale'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.StoreItem'], null=True, blank=True)),
            ...
            ('text', self.gf('django.db.models.fields.TextField')(default='', max_length=3000, blank=True)),
            ('order_index', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'Store', ['SaleItem'])

        # Removing M2M table for field service_items on 'Sale'
        db.delete_table(db.shorten_name(u'Store_sale_service_items'))


        # Changing field 'Sale.action'
        db.alter_column(u'Store_sale', 'action_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['Crm.Action'], unique=True))
        # Adding unique constraint on 'Sale', fields ['action']
        db.create_unique(u'Store_sale', ['action_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sale', fields ['action']
        db.delete_unique(u'Store_sale', ['action_id'])
        ...
        db.delete_table(u'Store_saleitem')
        ...
        # Changing field 'Sale.action'
        db.alter_column(u'Store_sale', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.Action'], null=True))
