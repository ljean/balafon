...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemTag.show_always'
        db.add_column(u'Store_storeitemtag', 'show_always',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemTag.show_always'
        db.delete_column(u'Store_storeitemtag', 'show_always')
