...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field readonly_status on 'StoreManagementActionType'
        m2m_table_name = db.shorten_name(u'Store_storemanagementactiontype_readonly_status')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('storemanagementactiontype', models.ForeignKey(orm[u'Store.storemanagementactiontype'], null=False)),
            ('actionstatus', models.ForeignKey(orm[u'Crm.actionstatus'], null=False))
        ))
        db.create_unique(m2m_table_name, ['storemanagementactiontype_id', 'actionstatus_id'])


    def backwards(self, orm):
        # Removing M2M table for field readonly_status on 'StoreManagementActionType'
        db.delete_table(db.shorten_name(u'Store_storemanagementactiontype_readonly_status'))
