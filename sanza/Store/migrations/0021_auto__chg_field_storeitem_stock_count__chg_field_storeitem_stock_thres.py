...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StoreItem.stock_count'
        db.alter_column(u'Store_storeitem', 'stock_count', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2))

        # Changing field 'StoreItem.stock_threshold'
        db.alter_column(u'Store_storeitem', 'stock_threshold', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'StoreItem.stock_count'
        db.alter_column(u'Store_storeitem', 'stock_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'StoreItem.stock_threshold'
        db.alter_column(u'Store_storeitem', 'stock_threshold', self.gf('django.db.models.fields.IntegerField')(null=True))
