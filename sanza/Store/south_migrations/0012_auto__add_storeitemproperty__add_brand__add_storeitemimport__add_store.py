...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoreItemProperty'
        db.create_table(u'Store_storeitemproperty', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('label', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
        ))
        db.send_create_signal(u'Store', ['StoreItemProperty'])
        ...
        # Adding model 'StoreItemImport'
        db.create_table(u'Store_storeitemimport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('fields', self.gf('django.db.models.fields.CharField')(default='name,brand,reference,category,purchase_price,vat_rate', max_length=300)),
            ('last_import_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('import_error', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('is_successful', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('ignore_first_line', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('margin_rate', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=9, decimal_places=2)),
        ))
        db.send_create_signal(u'Store', ['StoreItemImport'])

        # Adding M2M table for field tags on 'StoreItemImport'
        m2m_table_name = db.shorten_name(u'Store_storeitemimport_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('storeitemimport', models.ForeignKey(orm[u'Store.storeitemimport'], null=False)),
            ('storeitemtag', models.ForeignKey(orm[u'Store.storeitemtag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['storeitemimport_id', 'storeitemtag_id'])

        # Adding model 'StoreItemPropertyValue'
        db.create_table(u'Store_storeitempropertyvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Store.StoreItem'])),
            ('property', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Store.StoreItemProperty'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'Store', ['StoreItemPropertyValue'])

        # Adding field 'StoreItem.brand'
        db.add_column(u'Store_storeitem', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.Brand'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'StoreItem.reference'
        db.add_column(u'Store_storeitem', 'reference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'StoreItem.imported_by'
        db.add_column(u'Store_storeitem', 'imported_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.StoreItemImport'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StoreItemProperty'
        db.delete_table(u'Store_storeitemproperty')

        # Deleting model 'Brand'
        db.delete_table(u'Store_brand')

        # Deleting model 'StoreItemImport'
        db.delete_table(u'Store_storeitemimport')

        # Removing M2M table for field tags on 'StoreItemImport'
        db.delete_table(db.shorten_name(u'Store_storeitemimport_tags'))

        # Deleting model 'StoreItemPropertyValue'
        db.delete_table(u'Store_storeitempropertyvalue')

        # Deleting field 'StoreItem.brand'
        db.delete_column(u'Store_storeitem', 'brand_id')

        # Deleting field 'StoreItem.reference'
        db.delete_column(u'Store_storeitem', 'reference')

        # Deleting field 'StoreItem.imported_by'
        db.delete_column(u'Store_storeitem', 'imported_by_id')
