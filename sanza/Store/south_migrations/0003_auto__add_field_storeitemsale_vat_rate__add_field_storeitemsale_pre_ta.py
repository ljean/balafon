...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemSale.vat_rate'
        db.add_column(u'Store_storeitemsale', 'vat_rate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Store.VatRate']),
                      keep_default=False)

        # Adding field 'StoreItemSale.pre_tax_price'
        db.add_column(u'Store_storeitemsale', 'pre_tax_price',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'StoreItemSale.text'
        db.add_column(u'Store_storeitemsale', 'text',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=3000, blank=True),
                      keep_default=False)


        # Changing field 'StoreItemSale.item'
        db.alter_column(u'Store_storeitemsale', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Store.StoreItem'], null=True))

    def backwards(self, orm):
        # Deleting field 'StoreItemSale.vat_rate'
        db.delete_column(u'Store_storeitemsale', 'vat_rate_id')

        # Deleting field 'StoreItemSale.pre_tax_price'
        db.delete_column(u'Store_storeitemsale', 'pre_tax_price')

        # Deleting field 'StoreItemSale.text'
        db.delete_column(u'Store_storeitemsale', 'text')


        # User chose to not deal with backwards NULL issues for 'StoreItemSale.item'
        raise RuntimeError("Cannot reverse this migration. 'StoreItemSale.item' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'StoreItemSale.item'
        db.alter_column(u'Store_storeitemsale', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Store.StoreItem']))
