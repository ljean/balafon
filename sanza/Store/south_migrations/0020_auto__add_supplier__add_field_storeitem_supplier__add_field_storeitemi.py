...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Store_supplier', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'Store', ['Supplier'])

        # Adding field 'StoreItem.supplier'
        db.add_column(u'Store_storeitem', 'supplier',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.Supplier'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'StoreItemImport.supplier'
        db.add_column(u'Store_storeitemimport', 'supplier',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.Supplier'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'Store_supplier')

        # Deleting field 'StoreItem.supplier'
        db.delete_column(u'Store_storeitem', 'supplier_id')

        # Deleting field 'StoreItemImport.supplier'
        db.delete_column(u'Store_storeitemimport', 'supplier_id')
