...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemProperty.is_public'
        db.add_column(u'Store_storeitemproperty', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemProperty.is_public'
        db.delete_column(u'Store_storeitemproperty', 'is_public')
