...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemProperty.in_fullname'
        db.add_column(u'Store_storeitemproperty', 'in_fullname',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemProperty.in_fullname'
        db.delete_column(u'Store_storeitemproperty', 'in_fullname')
