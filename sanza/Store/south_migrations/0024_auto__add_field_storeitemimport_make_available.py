...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemImport.make_available'
        db.add_column(u'Store_storeitemimport', 'make_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemImport.make_available'
        db.delete_column(u'Store_storeitemimport', 'make_available')
