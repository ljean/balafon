...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItem.available'
        db.add_column(u'Store_storeitem', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItem.available'
        db.delete_column(u'Store_storeitem', 'available')
