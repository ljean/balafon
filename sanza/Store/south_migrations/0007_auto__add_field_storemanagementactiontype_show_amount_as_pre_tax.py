...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreManagementActionType.show_amount_as_pre_tax'
        db.add_column(u'Store_storemanagementactiontype', 'show_amount_as_pre_tax',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreManagementActionType.show_amount_as_pre_tax'
        db.delete_column(u'Store_storemanagementactiontype', 'show_amount_as_pre_tax')
