...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemTag.icon'
        db.add_column(u'Store_storeitemtag', 'icon',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'StoreItemCategory.icon'
        db.add_column(u'Store_storeitemcategory', 'icon',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemTag.icon'
        db.delete_column(u'Store_storeitemtag', 'icon')

        # Deleting field 'StoreItemCategory.icon'
        db.delete_column(u'Store_storeitemcategory', 'icon')
