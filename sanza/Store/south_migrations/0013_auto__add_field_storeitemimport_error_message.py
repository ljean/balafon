...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemImport.error_message'
        db.add_column(u'Store_storeitemimport', 'error_message',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemImport.error_message'
        db.delete_column(u'Store_storeitemimport', 'error_message')
