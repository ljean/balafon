...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PriceClass'
        db.create_table(u'Store_priceclass', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'Store', ['PriceClass'])

        # Adding M2M table for field discounts on 'PriceClass'
        m2m_table_name = db.shorten_name(u'Store_priceclass_discounts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('priceclass', models.ForeignKey(orm[u'Store.priceclass'], null=False)),
            ('discount', models.ForeignKey(orm[u'Store.discount'], null=False))
        ))
        db.create_unique(m2m_table_name, ['priceclass_id', 'discount_id'])

        # Adding field 'StoreItem.price_class'
        db.add_column(u'Store_storeitem', 'price_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Store.PriceClass'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PriceClass'
        db.delete_table(u'Store_priceclass')

        # Removing M2M table for field discounts on 'PriceClass'
        db.delete_table(db.shorten_name(u'Store_priceclass_discounts'))

        # Deleting field 'StoreItem.price_class'
        db.delete_column(u'Store_storeitem', 'price_class_id')
    ...
    models = {
        ...
        u'Store.discount': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '9', 'decimal_places': '2'}),
            'rate': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '4', 'decimal_places': '2'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Store.StoreItemTag']", 'symmetrical': 'False', 'blank': 'True'})
        },
        u'Store.priceclass': {
            'Meta': {'object_name': 'PriceClass'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'discounts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Store.Discount']", 'symmetrical': 'False', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'Store.pricepolicy': {
        ...
        u'Store.saleitem': {
            ...
            'discount': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['Store.Discount']", 'null': 'True', 'blank': 'True'}),
            ...
            'vat_rate': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['Store.VatRate']", 'null': 'True', 'blank': 'True'})
        },
        u'Store.storeitem': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'pre_tax_price': ('django.db.models.fields.DecimalField', [], {'max_digits': '9', 'decimal_places': '2'}),
            'price_class': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['Store.PriceClass']", 'null': 'True', 'blank': 'True'}),
            ...
            'stock_count': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '9', 'decimal_places': '2', 'blank': 'True'}),
            'stock_threshold': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '9', 'decimal_places': '2', 'blank': 'True'}),
            'supplier': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['Store.Supplier']", 'null': 'True', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['Store.StoreItemTag']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'Store.storeitemimport': {
            ...
            'make_available': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
