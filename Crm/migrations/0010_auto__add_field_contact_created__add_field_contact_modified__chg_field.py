...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Crm_contact', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Contact.modified'
        db.add_column('Crm_contact', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Changing field 'ActionType.name'
        db.alter_column('Crm_actiontype', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting field 'Contact.created'
        db.delete_column('Crm_contact', 'created')

        # Deleting field 'Contact.modified'
        db.delete_column('Crm_contact', 'modified')

        # Changing field 'ActionType.name'
        db.alter_column('Crm_actiontype', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'Crm.membership': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Crm.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joining_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'leaving_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
