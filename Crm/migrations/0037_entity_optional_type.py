...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Crm_entity', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.EntityType'], null=True))

    def backwards(self, orm):

        # Changing field 'Entity.type'
        db.alter_column('Crm_entity', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Crm.EntityType']))
