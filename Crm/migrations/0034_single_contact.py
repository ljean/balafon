...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.is_single_contact'
        db.add_column('Crm_entity', 'is_single_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.is_single_contact'
        db.delete_column('Crm_entity', 'is_single_contact')
