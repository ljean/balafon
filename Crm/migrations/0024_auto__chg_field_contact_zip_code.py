...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.zip_code'
        db.alter_column('Crm_contact', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Contact.zip_code'
        db.alter_column('Crm_contact', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=10))
