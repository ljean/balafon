...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SameAs'
        db.create_table('Crm_sameas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('Crm', ['SameAs'])

        # Adding field 'Contact.same_as'
        db.add_column('Crm_contact', 'same_as', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.SameAs'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SameAs'
        db.delete_table('Crm_sameas')

        # Deleting field 'Contact.same_as'
        db.delete_column('Crm_contact', 'same_as_id')
