...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpportunityStatus.ordering'
        db.add_column('Crm_opportunitystatus', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpportunityStatus.ordering'
        db.delete_column('Crm_opportunitystatus', 'ordering')
