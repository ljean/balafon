...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContactsImport'
        db.create_table('Crm_contactsimport', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, blank=True)),
            ('imported_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('entity_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.EntityType'])),
            ('relationship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.Relationship'])),
            ('activity_sector', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.ActivitySector'], null=True, blank=True)),
        ))
        db.send_create_signal('Crm', ['ContactsImport'])

        # Adding M2M table for field groups on 'ContactsImport'
        db.create_table('Crm_contactsimport_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contactsimport', models.ForeignKey(orm['Crm.contactsimport'], null=False)),
            ('group', models.ForeignKey(orm['Crm.group'], null=False))
        ))
        db.create_unique('Crm_contactsimport_groups', ['contactsimport_id', 'group_id'])

        # Adding field 'Contact.imported_by'
        db.add_column('Crm_contact', 'imported_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.ContactsImport'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ContactsImport'
        db.delete_table('Crm_contactsimport')

        # Removing M2M table for field groups on 'ContactsImport'
        db.delete_table('Crm_contactsimport_groups')

        # Deleting field 'Contact.imported_by'
        db.delete_column('Crm_contact', 'imported_by_id')
    ...
    models = {
        ...
        'Crm.contactsimport': {
            ...
            'activity_sector': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['Crm.ActivitySector']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
