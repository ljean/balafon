...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactsImport.entity_name_from_email'
        db.add_column('Crm_contactsimport', 'entity_name_from_email', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactsImport.entity_name_from_email'
        db.delete_column('Crm_contactsimport', 'entity_name_from_email')
