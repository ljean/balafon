...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ContactsImport.relationship'
        db.delete_column('Crm_contactsimport', 'relationship_id')

        # Deleting field 'ContactsImport.activity_sector'
        db.delete_column('Crm_contactsimport', 'activity_sector_id')

        # Deleting field 'Entity.activity_sector'
        db.delete_column('Crm_entity', 'activity_sector_id')

        # Deleting field 'Entity.relationship'
        db.delete_column('Crm_entity', 'relationship_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ContactsImport.relationship'
        raise RuntimeError("Cannot reverse this migration. 'ContactsImport.relationship' and its values cannot be restored.")

        # Adding field 'ContactsImport.activity_sector'
        db.add_column('Crm_contactsimport', 'activity_sector', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.ActivitySector'], null=True, blank=True), keep_default=False)

        # Adding field 'Entity.activity_sector'
        db.add_column('Crm_entity', 'activity_sector', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.ActivitySector'], null=True, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Entity.relationship'
        raise RuntimeError("Cannot reverse this migration. 'Entity.relationship' and its values cannot be restored.")
