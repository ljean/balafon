...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Crm_contact', 'address', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True), keep_default=False)

        # Adding field 'Contact.zip_code'
        db.add_column('Crm_contact', 'zip_code', self.gf('django.db.models.fields.CharField')(default=u'', max_length=10, blank=True), keep_default=False)

        # Adding field 'Contact.cedex'
        ...
        db.add_column('Crm_contact', 'notes', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.address'
        db.delete_column('Crm_contact', 'address')

        # Deleting field 'Contact.zip_code'
        db.delete_column('Crm_contact', 'zip_code')

        # Deleting field 'Contact.cedex'
        db.delete_column('Crm_contact', 'cedex')

        # Deleting field 'Contact.city'
        db.delete_column('Crm_contact', 'city_id')

        # Deleting field 'Contact.notes'
        db.delete_column('Crm_contact', 'notes')
