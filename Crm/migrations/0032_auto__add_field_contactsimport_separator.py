...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactsImport.separator'
        db.add_column('Crm_contactsimport', 'separator', self.gf('django.db.models.fields.CharField')(default=',', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactsImport.separator'
        db.delete_column('Crm_contactsimport', 'separator')
