...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Contact', fields ['main_contact']
        db.create_index('Crm_contact', ['main_contact'])

        # Adding index on 'Contact', fields ['lastname']
        db.create_index('Crm_contact', ['lastname'])

        # Adding index on 'Contact', fields ['accept_newsletter']
        db.create_index('Crm_contact', ['accept_newsletter'])

        # Adding index on 'Group', fields ['name']
        db.create_index('Crm_group', ['name'])

        # Adding index on 'Entity', fields ['name']
        db.create_index('Crm_entity', ['name'])

        # Adding index on 'Action', fields ['done_date']
        db.create_index('Crm_action', ['done_date'])

        # Adding index on 'Action', fields ['planned_date']
        db.create_index('Crm_action', ['planned_date'])

        # Adding index on 'Action', fields ['display_on_board']
        db.create_index('Crm_action', ['display_on_board'])

        # Adding index on 'Action', fields ['done']
        db.create_index('Crm_action', ['done'])

        # Adding index on 'Opportunity', fields ['ended']
        db.create_index('Crm_opportunity', ['ended'])

        # Adding index on 'Opportunity', fields ['display_on_board']
        db.create_index('Crm_opportunity', ['display_on_board'])


    def backwards(self, orm):
        
        # Removing index on 'Opportunity', fields ['display_on_board']
        db.delete_index('Crm_opportunity', ['display_on_board'])

        # Removing index on 'Opportunity', fields ['ended']
        db.delete_index('Crm_opportunity', ['ended'])

        # Removing index on 'Action', fields ['done']
        db.delete_index('Crm_action', ['done'])

        # Removing index on 'Action', fields ['display_on_board']
        db.delete_index('Crm_action', ['display_on_board'])

        # Removing index on 'Action', fields ['planned_date']
        db.delete_index('Crm_action', ['planned_date'])

        # Removing index on 'Action', fields ['done_date']
        db.delete_index('Crm_action', ['done_date'])

        # Removing index on 'Entity', fields ['name']
        db.delete_index('Crm_entity', ['name'])

        # Removing index on 'Group', fields ['name']
        db.delete_index('Crm_group', ['name'])

        # Removing index on 'Contact', fields ['accept_newsletter']
        db.delete_index('Crm_contact', ['accept_newsletter'])

        # Removing index on 'Contact', fields ['lastname']
        db.delete_index('Crm_contact', ['lastname'])

        # Removing index on 'Contact', fields ['main_contact']
        db.delete_index('Crm_contact', ['main_contact'])
