...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Crm_actionset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('Crm', ['ActionSet'])

        # Adding field 'Action.archived'
        db.add_column('Crm_action', 'archived',
        ...
        # Adding field 'Action.amount'
        db.add_column('Crm_action', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)


        # Changing field 'Action.entity'
        db.alter_column('Crm_action', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.Entity'], null=True))
        # Adding field 'ActionType.set'
        db.add_column('Crm_actiontype', 'set',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.ActionSet'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ActionSet'
        db.delete_table('Crm_actionset')

        # Deleting field 'Action.archived'
        db.delete_column('Crm_action', 'archived')

        # Deleting field 'Action.note'
        db.delete_column('Crm_action', 'note')

        # Deleting field 'Action.amount'
        db.delete_column('Crm_action', 'amount')


        # User chose to not deal with backwards NULL issues for 'Action.entity'
        raise RuntimeError("Cannot reverse this migration. 'Action.entity' and its values cannot be restored.")
        # Deleting field 'ActionType.set'
        db.delete_column('Crm_actiontype', 'set_id')
