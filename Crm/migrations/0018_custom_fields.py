...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Crm_customfield', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('label', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('model', self.gf('django.db.models.fields.IntegerField')()),
            ('widget', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('simple_form', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('Crm', ['CustomField'])

        # Adding model 'EntityCustomFieldValue'
        db.create_table('Crm_entitycustomfieldvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('custom_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.CustomField'])),
            ('value', self.gf('django.db.models.fields.TextField')()),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.Entity'])),
        ))
        db.send_create_signal('Crm', ['EntityCustomFieldValue'])

        # Adding model 'ContactCustomFieldValue'
        db.create_table('Crm_contactcustomfieldvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('custom_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.CustomField'])),
            ('value', self.gf('django.db.models.fields.TextField')()),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.Contact'])),
        ))
        db.send_create_signal('Crm', ['ContactCustomFieldValue'])


    def backwards(self, orm):
        
        # Deleting model 'CustomField'
        db.delete_table('Crm_customfield')

        # Deleting model 'EntityCustomFieldValue'
        db.delete_table('Crm_entitycustomfieldvalue')

        # Deleting model 'ContactCustomFieldValue'
        db.delete_table('Crm_contactcustomfieldvalue')
    ...
    models = {
        ...
        'Crm.customfield': {
            ...
            'simple_form': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
