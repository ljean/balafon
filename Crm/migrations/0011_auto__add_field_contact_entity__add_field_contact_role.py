...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Crm_contact', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.Entity'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('Crm_contact', 'entity_id')
