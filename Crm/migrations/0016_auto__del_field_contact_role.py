...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('Crm_contact', 'role_id')

        # Adding M2M table for field role on 'Contact'
        db.create_table('Crm_contact_role', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contact', models.ForeignKey(orm['Crm.contact'], null=False)),
            ('entityrole', models.ForeignKey(orm['Crm.entityrole'], null=False))
        ))
        db.create_unique('Crm_contact_role', ['contact_id', 'entityrole_id'])


    def backwards(self, orm):
        
        # Adding field 'Contact.role'
        db.add_column('Crm_contact', 'role', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.EntityRole'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field role on 'Contact'
        db.delete_table('Crm_contact_role')
