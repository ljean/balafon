...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomField.export_order'
        db.add_column('Crm_customfield', 'export_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomField.export_order'
        db.delete_column('Crm_customfield', 'export_order')
