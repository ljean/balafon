...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Profile_contactprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('contact', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['Crm.Contact'], unique=True)),
        ))
        db.send_create_signal('Profile', ['ContactProfile'])


    def backwards(self, orm):
        # Deleting model 'ContactProfile'
        db.delete_table('Profile_contactprofile')
    ...
    models = {
        ...
        'Profile.contactprofile': {
            ...
            'contact': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['Crm.Contact']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
