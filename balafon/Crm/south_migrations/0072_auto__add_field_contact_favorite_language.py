...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.favorite_language'
        db.add_column(u'Crm_contact', 'favorite_language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.favorite_language'
        db.delete_column(u'Crm_contact', 'favorite_language')
