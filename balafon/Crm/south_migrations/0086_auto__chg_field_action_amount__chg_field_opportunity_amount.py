...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action.amount'
        db.alter_column(u'Crm_action', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Opportunity.amount'
        db.alter_column(u'Crm_opportunity', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Action.amount'
        db.alter_column(u'Crm_action', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=2))

        # Changing field 'Opportunity.amount'
        db.alter_column(u'Crm_opportunity', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=2))
