...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Crm_subscriptiontype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'Crm', ['SubscriptionType'])

        # Adding model 'Subscription'
        db.create_table(u'Crm_subscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.SubscriptionType'])),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.Contact'])),
            ('accept_subscription', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('subscription_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('unsubscription_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'Crm', ['Subscription'])


    def backwards(self, orm):
        # Deleting model 'SubscriptionType'
        db.delete_table(u'Crm_subscriptiontype')

        # Deleting model 'Subscription'
        db.delete_table(u'Crm_subscription')
