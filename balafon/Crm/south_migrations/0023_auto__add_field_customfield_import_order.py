...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomField.import_order'
        db.add_column('Crm_customfield', 'import_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomField.import_order'
        db.delete_column('Crm_customfield', 'import_order')
