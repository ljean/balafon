...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Crm_opportunity', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Opportunity.amount'
        db.alter_column('Crm_opportunity', 'amount', self.gf('django.db.models.fields.PositiveIntegerField')())
