...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OpportunityType'
        db.create_table('Crm_opportunitytype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Account.Account'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('Crm', ['OpportunityType'])

        # Adding field 'Opportunity.type'
        db.add_column('Crm_opportunity', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.OpportunityType'], null=True, blank=True), keep_default=False)

        # Adding field 'Opportunity.start_date'
        db.add_column('Crm_opportunity', 'start_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)

        # Changing field 'OpportunityStatus.name'
        db.alter_column('Crm_opportunitystatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting model 'OpportunityType'
        db.delete_table('Crm_opportunitytype')

        # Deleting field 'Opportunity.type'
        db.delete_column('Crm_opportunity', 'type_id')

        # Deleting field 'Opportunity.start_date'
        db.delete_column('Crm_opportunity', 'start_date')

        # Changing field 'OpportunityStatus.name'
        db.alter_column('Crm_opportunitystatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
