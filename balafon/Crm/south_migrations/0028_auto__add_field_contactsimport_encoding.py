...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactsImport.encoding'
        db.add_column('Crm_contactsimport', 'encoding', self.gf('django.db.models.fields.CharField')(default='iso-8859-15', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContactsImport.encoding'
        db.delete_column('Crm_contactsimport', 'encoding')
