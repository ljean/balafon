...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ZoneType.type'
        db.add_column('Crm_zonetype', 'type', self.gf('django.db.models.fields.CharField')(default='department', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ZoneType.type'
        db.delete_column('Crm_zonetype', 'type')
