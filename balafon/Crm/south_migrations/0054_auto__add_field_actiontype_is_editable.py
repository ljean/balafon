...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.is_editable'
        db.add_column(u'Crm_actiontype', 'is_editable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.is_editable'
        db.delete_column(u'Crm_actiontype', 'is_editable')
