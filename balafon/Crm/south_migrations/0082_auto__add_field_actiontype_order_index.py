...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.order_index'
        db.add_column(u'Crm_actiontype', 'order_index',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.order_index'
        db.delete_column(u'Crm_actiontype', 'order_index')
