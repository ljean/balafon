...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionType.action_template'
        db.add_column(u'Crm_actiontype', 'action_template',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionType.action_template'
        db.delete_column(u'Crm_actiontype', 'action_template')
