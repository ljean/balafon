...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.billing_address'
        db.add_column(u'Crm_entity', 'billing_address',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Entity.billing_address2'
        db.add_column(u'Crm_entity', 'billing_address2',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Entity.billing_address3'
        db.add_column(u'Crm_entity', 'billing_address3',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Entity.billing_zip_code'
        db.add_column(u'Crm_entity', 'billing_zip_code',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Entity.billing_cedex'
        db.add_column(u'Crm_entity', 'billing_cedex',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Entity.billing_city'
        db.add_column(u'Crm_entity', 'billing_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='entity_billing_set', null=True, blank=True, to=orm['Crm.City']),
                      keep_default=False)

        # Adding field 'Entity.billing_street_number'
        db.add_column(u'Crm_entity', 'billing_street_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Entity.billing_street_type'
        db.add_column(u'Crm_entity', 'billing_street_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='entity_billing_set', null=True, blank=True, to=orm['Crm.StreetType']),
                      keep_default=False)

        # Adding field 'Contact.billing_address'
        db.add_column(u'Crm_contact', 'billing_address',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contact.billing_address2'
        db.add_column(u'Crm_contact', 'billing_address2',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contact.billing_address3'
        db.add_column(u'Crm_contact', 'billing_address3',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contact.billing_zip_code'
        db.add_column(u'Crm_contact', 'billing_zip_code',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Contact.billing_cedex'
        db.add_column(u'Crm_contact', 'billing_cedex',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contact.billing_city'
        db.add_column(u'Crm_contact', 'billing_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='contact_billing_set', null=True, blank=True, to=orm['Crm.City']),
                      keep_default=False)

        # Adding field 'Contact.billing_street_number'
        db.add_column(u'Crm_contact', 'billing_street_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Contact.billing_street_type'
        db.add_column(u'Crm_contact', 'billing_street_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='contact_billing_set', null=True, blank=True, to=orm['Crm.StreetType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.billing_address'
        db.delete_column(u'Crm_entity', 'billing_address')

        # Deleting field 'Entity.billing_address2'
        db.delete_column(u'Crm_entity', 'billing_address2')

        # Deleting field 'Entity.billing_address3'
        db.delete_column(u'Crm_entity', 'billing_address3')

        # Deleting field 'Entity.billing_zip_code'
        db.delete_column(u'Crm_entity', 'billing_zip_code')

        # Deleting field 'Entity.billing_cedex'
        db.delete_column(u'Crm_entity', 'billing_cedex')

        # Deleting field 'Entity.billing_city'
        db.delete_column(u'Crm_entity', 'billing_city_id')

        # Deleting field 'Entity.billing_street_number'
        db.delete_column(u'Crm_entity', 'billing_street_number')

        # Deleting field 'Entity.billing_street_type'
        db.delete_column(u'Crm_entity', 'billing_street_type_id')

        # Deleting field 'Contact.billing_address'
        db.delete_column(u'Crm_contact', 'billing_address')

        # Deleting field 'Contact.billing_address2'
        db.delete_column(u'Crm_contact', 'billing_address2')

        # Deleting field 'Contact.billing_address3'
        db.delete_column(u'Crm_contact', 'billing_address3')

        # Deleting field 'Contact.billing_zip_code'
        db.delete_column(u'Crm_contact', 'billing_zip_code')

        # Deleting field 'Contact.billing_cedex'
        db.delete_column(u'Crm_contact', 'billing_cedex')

        # Deleting field 'Contact.billing_city'
        db.delete_column(u'Crm_contact', 'billing_city_id')

        # Deleting field 'Contact.billing_street_number'
        db.delete_column(u'Crm_contact', 'billing_street_number')

        # Deleting field 'Contact.billing_street_type'
        db.delete_column(u'Crm_contact', 'billing_street_type_id')
