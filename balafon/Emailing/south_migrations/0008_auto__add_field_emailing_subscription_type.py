...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emailing.subscription_type'
        db.add_column(u'Emailing_emailing', 'subscription_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Crm.SubscriptionType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emailing.subscription_type'
        db.delete_column(u'Emailing_emailing', 'subscription_type_id')
    ...
    models = {
        ...
        u'Emailing.emailing': {
            ...
            'subscription_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['Crm.SubscriptionType']", 'null': 'True', 'blank': 'True'})
        },
