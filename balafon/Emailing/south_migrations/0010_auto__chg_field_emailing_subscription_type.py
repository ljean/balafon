...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Emailing.subscription_type'
        db.alter_column(u'Emailing_emailing', 'subscription_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Crm.SubscriptionType']))

    def backwards(self, orm):

        # Changing field 'Emailing.subscription_type'
        db.alter_column(u'Emailing_emailing', 'subscription_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Crm.SubscriptionType'], null=True))
