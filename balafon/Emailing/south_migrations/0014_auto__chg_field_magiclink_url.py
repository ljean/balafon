...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MagicLink.url'
        db.alter_column(u'Emailing_magiclink', 'url', self.gf('django.db.models.fields.URLField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'MagicLink.url'
        db.alter_column(u'Emailing_magiclink', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
