...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactProfile.lastname'
        db.add_column(u'Profile_contactprofile', 'lastname',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'ContactProfile.firstname'
        db.add_column(u'Profile_contactprofile', 'firstname',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactProfile.lastname'
        db.delete_column(u'Profile_contactprofile', 'lastname')

        # Deleting field 'ContactProfile.firstname'
        db.delete_column(u'Profile_contactprofile', 'firstname')
