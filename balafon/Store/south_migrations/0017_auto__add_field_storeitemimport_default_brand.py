...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoreItemImport.default_brand'
        db.add_column(u'Store_storeitemimport', 'default_brand',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoreItemImport.default_brand'
        db.delete_column(u'Store_storeitemimport', 'default_brand')
