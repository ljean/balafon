...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discount.short_name'
        db.add_column(u'Store_discount', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discount.short_name'
        db.delete_column(u'Store_discount', 'short_name')
